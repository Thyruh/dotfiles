...
(custom-theme-set-faces
 ...
 '(agda2-highlight-function-face ((t (:foreground "midnight blue"))))
 '(agda2-highlight-keyword-face ((t (:foreground "" :weight bold))))
 ...
 '(secondary-selection ((t (:foreground nil :background "#00000000"))))
 ...
 '(font-lock-preprocessor-face ((t (:foreground "thistle"))))
 ...
 '(helm-ff-directory ((t (:foreground "#96a6c8" :background "#0e070d" :bold t))))
 '(helm-ff-executable ((t (:foreground "#73c936"))))
 '(helm-ff-file ((t (:foreground "#e4e4ef" :inherit unspecified))))
 '(helm-ff-invalid-symlink ((t (:foreground "#0e070d" :background "#f43841"))))
 ...
 '(helm-source-header ((t (:foreground "#ffdd33" :background "#0e070d" :box (:line-width -1 :style released-button)))))
 ...
 '(linum ((t `(list :foreground sexy-quartz :background sexy-bg))))
 ...
 '(magit-tag ((t (:foreground "#ffdd33" :background "#0e070d"))))
 ...
 '(whitespace-space ((t (:background "#0e070d" :foreground "#282828"))))
 '(whitespace-tab ((t (:background "#0e070d" :foreground "#282828"))))
 '(whitespace-hspace ((t (:background "#0e070d" :foreground "#453d41"))))
 '(whitespace-line ((t (:background "#453d41" :foreground "#ff4f58"))))
 '(whitespace-newline ((t (:background "#0e070d" :foreground "#453d41"))))
 ...
 '(default ((t (:foreground "#e4e4ef" :background "#0e070d")))))

(provide-theme 'sexy-changed)
